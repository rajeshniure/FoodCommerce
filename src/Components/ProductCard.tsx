    ...
    <div className="rounded-lg overflow-hidden">
      <div className="relative">
        ...
        {quantity === 0 ? (
          ...
          <button className="relative bottom-4 left-1/2 transform -translate-x-1/2 bg-orange-500 text-sm px-4 py-2 rounded-3xl hover:bg-orange-600 flex gap-6 items-center cursor-pointer">
            <button
              onClick={onDecrement}
              className="w-4 h-4 border rounded-full flex items-center justify-center text-gray-600 hover:bg-gray-300 cursor-pointer"
            >
              <img
      ...
      <div className="px-4">
        <h2 className="text-shadow-amber-200 text-gray-400">
          {product.description}
        </h2>
